...
// prepareStoreForGarbageCollectionInPrefix populates the store with dummy snapshots in either the old or the updated drectory structures for garbage collection tests
//Tied up with backward compatibility tests
//TODO: Consider removing when backward compatibility no longer needed
